...
// Some optional Redux functions related to user authentication and agent
// import { setCurrentUser, logoutUser } from '../src/services/auth/actions';
import { setCurrentUserAgent } from "../src/services/agent/actions";
  ...
  */
  ...
  fs.readFile(
    ...
    (err, htmlData) => {
      ...
      if ("anardoni" in req.cookies) {
        // store.dispatch(setCurrentUser(req.cookies.anardoni));
      } else {
        // store.dispatch(logoutUser());
      }
      // set current agent
      store.dispatch(setCurrentUserAgent(req.headers["user-agent"]));
